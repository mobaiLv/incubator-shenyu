...
public class DefaultFallbackController {
    ...
    public Object hystrixPluginFallback() {
        ...
        return ShenyuResultWrap.error(ShenyuResultEnum.HYSTRIX_PLUGIN_FALLBACK, null).getData();
    }
    ...
    public Object resilience4jFallBack() {
        ...
        return ShenyuResultWrap.error(ShenyuResultEnum.RESILIENCE4J_PLUGIN_FALLBACK, null).getData();
    }
}
